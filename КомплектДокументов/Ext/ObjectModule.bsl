...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Назначение.Добавить("Документ.Доверенность");
...
Функция ИмяФайлаРеализация(Документ, ТаблицаПечатныхФорм)
	...
	ИмяФайла = Лев(ОбщегоНазначенияКлиентСервер.ЗаменитьНедопустимыеСимволыВИмениФайла(ИмяФайла, " "), 146);
