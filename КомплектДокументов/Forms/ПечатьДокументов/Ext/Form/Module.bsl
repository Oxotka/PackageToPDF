...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("ПутьКФайлам", ПутьКФайлам);
	...
	Элементы.ГруппаПредупреждение.Видимость = (ТипЗнч(МассивСсылок) = Тип("Массив") И МассивСсылок.Количество() > 1);
	
	ЗаполнитьСписокВыбораПапкиДляСохранения(МассивСсылок);
	
	УправлениеПечатьюБППереопределяемый.ПечатьДокументовПриСозданииНаСервере(ЭтотОбъект);
...
Процедура ОбработкаНавигационнойСсылки(НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	УправлениеПечатьюКлиентБППереопределяемый.ОбработкаНавигационнойСсылки(ЭтотОбъект, 
...
Процедура СохранитьВPDF(Команда)
	...
	СохранитьФайлПакета(ТабличныеДокументы, ИмяФайла);
...
&НаСервере
Процедура СохранитьФайлПакета(ТабличныеДокументы, ИмяФайла)
...
Функция ИмяФайла()
	...
	Возврат РеквизитФормыВЗначение("Объект").ИмяФайла(ПутьКФайлам, Документ, НастройкиПечатныхФорм);
...
Процедура Подключаемый_ВыполнитьКоманду(Команда)
	...
	УправлениеПечатьюКлиентБППереопределяемый.ПечатьДокументовВыполнитьКоманду(ЭтотОбъект, Команда);
...
Процедура Подключаемый_ВыполнитьКомандуНаСервере(Контекст, Результат)
	...
	УправлениеПечатьюБППереопределяемый.ПечатьДокументовВыполнитьКоманду(ЭтотОбъект, Контекст, Результат);
