...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УправлениеПечатьюБП.ПечатьДокументовПриСозданииНаСервере(ЭтотОбъект);
...
Процедура Подключаемый_ВыполнитьКоманду(Команда)
	...
	УправлениеПечатьюБПКлиент.ПечатьДокументовВыполнитьКоманду(ЭтотОбъект, Команда);
...
Процедура Подключаемый_ВыполнитьКомандуНаСервере(Контекст, Результат)
	...
	Контекст.Свойство("ИмяКоманды", ИмяКоманды);
	Если ИмяКоманды = "ПодписьИПечать" Тогда
		УправлениеПечатьюБП.ПечататьФаксимилеПриИзмененииНаСервере(ЭтотОбъект, Контекст, Результат);
	КонецЕсли;
