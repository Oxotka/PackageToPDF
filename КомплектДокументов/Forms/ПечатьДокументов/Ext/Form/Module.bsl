...
Функция ИмяДокумента(Объекты)
	...
	Если Выборка.Следующий() Тогда
		Возврат СтрШаблон("тн № %1 от %2 - %3.pdf", Выборка.Номер, Формат(Выборка.Дата,"ДЛФ=D"), Выборка.Контрагент);
	Иначе
